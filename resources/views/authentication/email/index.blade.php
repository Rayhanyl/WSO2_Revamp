                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="p-2" style="border-radius:6px;"><a
                                                        href="{{ $mailData['url'] }}NewPassword?confirmation={{ $mailData['code'] }}&amp;userstoredomain=PRIMARY&amp;username={{ $mailData['name'] }}&amp;tenantdomain=carbon.super&amp;callback={{ $mailData['url'] }}Loginaccount"
                            ...
                            <tr>
                                <td style="text-align:left; vertical-align:top">
                                    <p style="margin-left:0; margin-right:0; text-align:left">If clicking the button
                                        ...
                                        browser.<br />
                                        <a href="{{ $mailData['url'] }}NewPassword?confirmation={{ $mailData['code'] }}&amp;userstoredomain=PRIMARY&amp;username={{ $mailData['name'] }}&amp;tenantdomain=carbon.super&amp;callback={{ $mailData['url'] }}Loginaccount"
                                            style="word-break: break-all; color: rgba(255, 80, 0, 1); font-size: 14px">{{ $mailData['url'] }}NewPassword?confirmation={{ $mailData['code'] }}&amp;userstoredomain=PRIMARY&amp;username={{ $mailData['name'] }}&amp;tenantdomain=carbon.super&amp;callback={{ $mailData['url'] }}Loginaccount</a>
                                    </p>
                                    &nbsp;
