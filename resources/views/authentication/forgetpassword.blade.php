...
<div class="container">
    <div class="card" data-aos="fade-up" data-aos-duration="1800">
        <div class="card-header">
            <h4>"Forgot Your Password? No Problem. Asabri Has You Covered.</h4>
            <p class="fw-light">
                To reset your password, simply click the "Forgot Password" link on the login page and follow the instructions. You'll be asked to enter the email associated with your account, and we'll send you a password reset link.
            </p>
        </div>
                            ...
                            <form action="{{ route ('sendmail') }}" method="POST">
                                ...
                                <div class="col-sm-12 mb-3">
                                    ...
                                    <div class="form-group position-relative has-icon-right">
                                        <input type="text" class="form-control round" placeholder="Enter your username." name="username" value="{{ old('username') }}">
                                ...
                                <div class="d-grid gap-2 my-3">
                                    <button class="btn btn-primary rounded-pill" type="submit">Reset password <i class="bi bi-arrow-clockwise"></i></button>
                                </div>
                            </form>
                        </div>
                    </div>
