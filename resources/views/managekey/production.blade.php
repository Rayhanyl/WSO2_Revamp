            ...
            <div class="row" data-aos="fade-right" data-aos-duration="1800">
                <div class="col-12 my-2 row">
                    ...
                    <div class="col-6 text-end">
                        <a href="{{ route ('sandbox',$application->applicationId) }}">
                            <h5>
                                Sandbox <i class="bi bi-arrow-right-circle"></i>
                            </h5>
                        </a>
                    </div>
                </div>
                <div class="divider">
                    <div class="divider-text fw-bold bg-transparent">
                        <h3>Production <i class="bi bi-box-fill"></i></h3>
                    </div>
                </div>
